...
<header style="background : var(--primary)">
    <div class="cont">
      ...
      <ul>
        <li>
          <img class="logo" src="asset/images/iquery-logo.png" alt="iquey-logo">
        </li>
        <li>
...
<section id="instruction" style="background : var(--primary)">
    <div class="cont-inner">
        <div class="cont-inner">
            <div class="instruction-title">
              <h2 class="title">
                  Before filling up any online form read these instructions carefully.
            </h2>
            </div>
        </div>
        <div class="row">
